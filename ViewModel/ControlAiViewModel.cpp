...
//    switch (train->getDirectionMultiplier()) {
...
//                    if (nextRail->getTrain()->getDirectionMultiplier() == ControlTrain::DIRECTION_REVERSE) {
//                        train->setTrainSpeed(ControlTrain::SPEED_BREAKE);
//                        rail->getNextLight()->setToggle(ControlLight::STATE_RED);
//                        break;
//                    }
...
//                if (nextRail->getTrain()) {
//                    if (nextRail->getTrain()->getDirectionMultiplier() == ControlTrain::DIRECTION_FORWARD) {
//                        train->setTrainSpeed(ControlTrain::SPEED_BREAKE);
//                        rail->getLastLight()->setToggle(ControlLight::STATE_RED);
//                        break;
//                    }
...
//        if (speedType == ENTERS) {
//            movingTrains.insert(train, ControlTrain::TrainSpeed(ControlTrain::SPEED_FORWARD_3 * train->getDirectionMultiplier()));
//        } else {
//            movingTrains.insert(train, ControlTrain::TrainSpeed(ControlTrain::SPEED_FORWARD_5 * train->getDirectionMultiplier()));
//        }
//        break;
...
//bool ControlAiViewModel::checkIfNotExistTrainWithHigherPriority(ControlTrain::TrainDirection direction, ControlRail *from, int priority, bool ignoreFlag)
//{
//    if (ignoreFlag) {
